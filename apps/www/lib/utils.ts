...
export function constructMetadata({
  ...
  description = "Eldora UI is a curated collection of the best landing page components built using React + Tailwind CSS + Motion",
  ...
  return {
    ...
    icons: "/favicon.ico",
    metadataBase: new URL("https://eldoraui.site"),
    authors: [
      {
        name: "karthikmudunuri",
        url: "https://twitter.com/karthikmudunuri",
      },
    ],
    creator: "karthikmudunuri",
    ...props,
